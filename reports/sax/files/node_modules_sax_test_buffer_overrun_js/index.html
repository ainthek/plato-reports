...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/sax/test/buffer-overrun.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/sax/test/buffer-overrun.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">// set this really low so that I don&#039;t have to put 64 MB of xml in here.
...
require(__dirname).test({
  ...
  .close();
sax.MAX_BUFFER_LENGTH = bl</textarea>
  </div>
</div>
