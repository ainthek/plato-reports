...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/selenium-webdriver/docs/dossier.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/selenium-webdriver/docs/dossier.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">(function(){var h,m=this;function aa(){}
...
void 0;v=void 0;D?v=&quot;-ms-transform&quot;:F?v=&quot;-webkit-transform&quot;:C?v=&quot;-o-transform&quot;:E&amp;&amp;(v=&quot;-moz-transform&quot;);var xa=void 0;v&amp;&amp;(xa=V(u,v));xa||(xa=V(u,&quot;transform&quot;));v=xa?(u=xa.match(Ec))?new I(parseFloat(u[1]),parseFloat(u[2])):new I(0,0):new I(0,0);v=new I(L.x+v.x,L.y+v.y)}else v=L;u=v}l.x+=u.x;l.y+=u.y}while(q&amp;&amp;q!=p&amp;&amp;(y=q.frameElement)&amp;&amp;(q=q.parent));n=$a(l,W(n));D&amp;&amp;!pb(k)&amp;&amp;(n=$a(n,qb(k)));g.left+=n.x;g.top+=n.y}b=(b&amp;4&amp;&amp;oc(d)?b^2:b)&amp;-5;b=new I(b&amp;2?g.left+g.width:g.left,b&amp;1?g.top+g.height:g.top);b=$a(b,
...
function be(a,b){var c=M(a),d=c.querySelector(&quot;i&quot;);if(!b.length)return d;var e=me(b),e=ub(Cb,{file:e,I:ie});ob(d);c.appendChild(e);return e}function ce(a,b,c){a=M(a);var d=a.querySelector(&quot;i&quot;);if((b=ub(Bb,{types:b,I:ie,ya:!!c}))&amp;&amp;b.childNodes.length)return ob(d),a.appendChild(b),b;sc(a,!1);return d}
...
oe);b(&quot;show-private&quot;,pe);d(document.getElementById(&quot;typedefs&quot;));d(document.getElementById(&quot;instance-methods&quot;));d(document.getElementById(&quot;instance-properties&quot;));d(document.getElementById(&quot;static-functions&quot;));d(document.getElementById(&quot;static-properties&quot;));d(document.getElementById(&quot;compiler-constants&quot;));sc(document.getElementById(&quot;visibility-controls&quot;),g.mb||g.lb||g.jb)}};;init();})();</textarea>
  </div>
</div>
