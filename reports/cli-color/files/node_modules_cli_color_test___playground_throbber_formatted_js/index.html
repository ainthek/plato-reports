...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/cli-color/test/__playground/throbber.formatted.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/cli-color/test/__playground/throbber.formatted.js</h1>
  </div>
</div>
...
throbber.start();
setTimeout(throbber.stop, 1100);</textarea>
  </div>
</div>
